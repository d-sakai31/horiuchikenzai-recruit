            ...
            {CULTURE.points.map((point, i) => (
              <div key={point.title}>
                <div className="flex items-baseline gap-3">
                  <span className="text-accent font-extrabold text-xl" aria-hidden="true">
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 text-sm border border-gray-300 rounded-lg px-5 py-2.5 hover:border-accent hover:text-accent transition-colors"
            >
