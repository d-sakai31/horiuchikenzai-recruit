            ...
            {CULTURE.points.map((point, i) => (
              <div key={point.title}>
                <div className="flex items-baseline gap-3">
                  <span className="text-primary font-extrabold text-xl" aria-hidden="true">
                ...
                <p className="mt-2 text-sm text-text-sub leading-relaxed pl-10">
                  {point.description}
                </p>
              </div>
            ))}
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 text-sm border border-gray-300 rounded-lg px-5 py-2.5 hover:border-primary hover:text-primary transition-colors"
            >
