...
export default function Culture() {
  return (
    <section id="culture" className="bg-bg-pale py-20 md:py-28">
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 text-sm border border-sub/50 rounded-full px-5 py-2.5 text-text-sub hover:border-primary hover:text-primary transition-colors"
            >
